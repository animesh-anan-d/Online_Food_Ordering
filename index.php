        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img id = "logo" src="images/logo2.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light"><h4><b>₹&nbsp;<?php echo $balance;?></b></h4></a>
                        </li>
                    </ul>					
                </div>
            </nav>
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <!--breadcrumbs start-->
        <div id="breadcrumbs-wrapper" id="bc">
          <div class="container">
            <div class="row">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption test"><h1>Order your food here. red</h1></p>
